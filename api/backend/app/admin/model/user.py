...
class User(Base):
    ...
    login_alias: Mapped[str | None] = mapped_column(
        sa.String(64), init=False, default=None, unique=True, index=True, comment='登录别名(kdit-昵称)'
    )
    ...
    real_name: Mapped[str | None] = mapped_column(sa.String(64), default=None, comment='真实姓名')
